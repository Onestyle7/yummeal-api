    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UserProfile>(entity =>
            {
                ...
                entity.Property(e => e.DailyProteinGoal)
                    .HasPrecision(6, 2);

                entity.Property(e => e.DailyCarbsGoal)
                    .HasPrecision(6, 2);

                entity.Property(e => e.DailyFatGoal)
                    .HasPrecision(6, 2);
            });
            ...
            modelBuilder.Entity<UserPreferences>(entity =>
            {
                ...
                entity.Property(e => e.MelsPerDay)
                    .HasDefaultValue(3);

                entity.Property(e => e.PlanningDays)
                    .HasDefaultValue(7);

                entity.Property(e => e.MaxCookingTime)
                    .HasDefaultValue(60);
                entity.Property(e => e.MaxCookingTime)
                    .HasDefaultValue(60);
            });
